...
import logo from '../../../assets/images/huddle-blue-logo.png'
...
function AdminLogin() {
  ...
  const handleSubmit = (e) => {
    ...
    .catch((err)=>{
      setErrorMessage(err?.response?.data?.message || err?.response?.data?.detail ||'Error')
      console.log(err, 'error_object')
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block h-[4em]" src={logo} alt="Logo" />
                <img className="dark:hidden h-[4em]" src={logo} alt="Logo" />
              </Link>
